...
while numPacketErrors<=maxNumErrors && numPkt<=maxNumPackets
    ...
    [rx,pathGains] = mimoChan(txPad,txStartTime*1e-6);  
    ...
    [perAbs,effSINR] = tgaxLinkPerformanceModel.estimateLinkPerformance(sinr,cfgHE);
    ...
    % and cyclic shift)
    chanEst = heChannelToChannelEstimate(chan,cfgHE,ruIndex);
    ...
    nVarEst = wlanHEDataNoiseEstimate(demodPilotSym,chanEstSSPilots,cfgHE);
